    ...
    <div v-else class="space-y-8">
      ...
      <div v-if="summary" class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">분석 영상</p>
              <p class="text-xl font-bold text-gray-900 dark:text-gray-100">
                {{ summary.totalVideos }}개
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">평균 전환율</p>
              <p class="text-xl font-bold text-gray-900 dark:text-gray-100">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">최고 전환 영상</p>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-3">
            ...
            <div>
              <p class="text-xs text-gray-500 dark:text-gray-400">최대 이탈 구간</p>
      ...
      <section>
          ...
          >
            <div class="mb-4 flex items-center justify-between">
              <div>
                ...
                <p class="mt-0.5 text-xs text-gray-500 dark:text-gray-400">{{ funnel.platform }} · 전환율 {{ funnel.overallConversion }}%</p>
              </div>
              <span
              ...
              >
                {{ funnel.overallConversion >= 1 ? '양호' : '개선 필요' }}
              </span>
            </div>
        ...
        >
          ...
          <h3 class="text-lg font-semibold text-gray-900 dark:text-gray-100">퍼널 데이터가 없습니다</h3>
          <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">영상을 업로드하면 퍼널 분석이 시작됩니다</p>
        </div>
      </section>
    </div>
  </div>
