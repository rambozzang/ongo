    ...
    <div class="mb-6 grid grid-cols-2 gap-4 desktop:grid-cols-4">
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="flex items-center gap-2">
          ...
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('fanInsights.totalFans') }}</p>
        </div>
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="flex items-center gap-2">
          ...
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('fanInsights.topAgeGroup') }}</p>
        </div>
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="flex items-center gap-2">
          ...
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('fanInsights.topCountry') }}</p>
        </div>
        <p class="mt-1 text-lg font-bold text-gray-900 dark:text-gray-100 truncate">
          {{ summary.topCountry || '-' }}
        </p>
      ...
      <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
        <div class="flex items-center gap-2">
          ...
          <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('fanInsights.peakActiveHour') }}</p>
        </div>
        <p class="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">
    ...
    <template v-else>
      ...
      <div v-if="activeTab === 'demographics'">
        ...
        >
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('fanInsights.noDemographics') }}</p>
        </div>
      </div>
      ...
      <div v-if="activeTab === 'behaviors'">
        ...
        >
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('fanInsights.noBehaviors') }}</p>
        </div>
      </div>
      ...
      <div v-if="activeTab === 'segments'">
        ...
        >
          ...
          <p class="text-sm text-gray-500 dark:text-gray-400">{{ $t('fanInsights.noSegments') }}</p>
        </div>
      </div>
    </template>
  </div>
