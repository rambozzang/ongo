      ...
      <div class="mb-6 grid grid-cols-2 gap-4 desktop:grid-cols-4">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-2">
            ...
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('liveStream.totalStreams') }}</p>
          </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-2">
            ...
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('liveStream.currentLive') }}</p>
          </div>
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-2">
            ...
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('liveStream.avgViewers') }}</p>
          </div>
          <p class="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-900">
          <div class="flex items-center gap-2">
            ...
            <p class="text-xs font-medium text-gray-500 dark:text-gray-400">{{ $t('liveStream.totalChats') }}</p>
          </div>
          <p class="mt-1 text-2xl font-bold text-gray-900 dark:text-gray-100">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center gap-2">
              ...
              <h2 class="text-sm font-semibold text-gray-900 dark:text-gray-100">
                {{ $t('liveStream.chatMessages') }} - {{ selectedStream.title }}
              </h2>
            </div>
            <span class="text-xs text-gray-400 dark:text-gray-500">
              {{ store.chats.length }}{{ $t('liveStream.messageUnit') }}
            </span>
          </div>
        </div>
