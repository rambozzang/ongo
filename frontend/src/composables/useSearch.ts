...
const pageEntries: PageEntry[] = [
  ...
  { id: 'p11', title: '예약 관리', group: '게시 & 자동화', route: '/schedule', keywords: 'schedule 스케줄 예약 게시' },
  { id: 'p12', title: '캘린더', group: '게시 & 자동화', route: '/calendar', keywords: 'calendar 달력 일정' },
  ...
  { id: 'p21', title: '댓글', group: '오디언스', route: '/comments', keywords: 'comments 코멘트 답글' },
  { id: 'p22', title: '인박스', group: '오디언스', route: '/inbox', keywords: 'inbox 메시지 dm' },
