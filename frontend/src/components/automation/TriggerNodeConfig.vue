...
<template>
  <div class="space-y-4">
    ...
    <div>
      <label class="block text-body-xs font-medium text-gray-600 dark:text-gray-400 mb-1">트리거 유형</label>
      <select
        :value="triggerType"
        class="input"
    ...
    <div v-if="triggerType === 'ANALYTICS_MILESTONE'" class="space-y-3">
      <div>
        <label class="block text-body-xs font-medium text-gray-600 dark:text-gray-400 mb-1">메트릭</label>
        <select
      ...
      <div>
        <label class="block text-body-xs font-medium text-gray-600 dark:text-gray-400 mb-1">임계값</label>
        <input
          type="number"
    ...
    <div v-if="triggerType === 'SUBSCRIBER_MILESTONE'" class="space-y-3">
      <div>
        <label class="block text-body-xs font-medium text-gray-600 dark:text-gray-400 mb-1">구독자 수</label>
        <input
          type="number"
    ...
    <p class="text-body-xs text-gray-500 dark:text-gray-400 mt-4">
