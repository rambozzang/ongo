        ...
        <div class="relative aspect-[9/16] overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-gray-900 to-black">
          ...
          <div class="absolute left-0 right-0 top-0 flex items-center justify-between px-4 py-3">
            <div class="flex items-center gap-2">
              ...
              <span class="text-body font-semibold text-white">릴스</span>
            </div>
          ...
          <div class="absolute bottom-0 left-0 right-14 px-4 pb-4">
            ...
            <div class="mb-2 flex items-center gap-2">
              ...
              <span class="text-body font-semibold text-white drop-shadow">
                {{ channelName || t('preview.username') }}
              </span>
              <span class="text-white/60">·</span>
              <button class="rounded-lg border border-white/80 px-3 py-0.5 text-body-xs font-semibold text-white">
                팔로우
              </button>
            </div>
            ...
            <div class="relative">
              <div
                ...
                class="text-body leading-relaxed text-white drop-shadow"
              >
              ...
              <div
                v-else
                class="max-h-32 overflow-y-auto text-body leading-relaxed text-white drop-shadow"
              >
            ...
            <div class="mt-1.5">
              <span
                ...
                :class="captionLength > 2200 ? 'text-error-strong' : 'text-white/60'"
              >
