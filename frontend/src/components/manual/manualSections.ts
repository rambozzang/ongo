    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'render.sh로 만든 완성 영상을 업로드한 뒤 클립의 "완성 영상 연결" 버튼으로 클립에 연결해야 게시 대상이 됩니다. 연결된 클립은 "연결됨"으로 표시됩니다.',
    ...
    content: [
      ...
      },
      {
        ...
        items: [
          ...
          'Upload the finished video made with render.sh, then use the clip\'s "Attach rendered video" button to link it — only attached clips become publishable. Attached clips show an "Attached" badge.',
